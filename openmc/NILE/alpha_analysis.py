...
filtered_data = df[(df['time low [s]'] > 1.05E-3) & (df['time low [s]'] < 1.5E-3)]
...
popt, pcov = curve_fit(fit, filtered_time*1000, filtered_flux)  #, p0=(0.015, 35, 2.25E-5, 0.09, 0), bounds=((0, 30, 0, 0, 0), (0.1, 40, 1E-4, 0.2, 0.1)))
plt.plot(t_vals, fit(t_vals, popt[0], popt[1], popt[2]), linestyle='-', color='black', linewidth=4)
