...
mats = openmc.Materials([conc_mat, poly, hdpe, air, steel, mirrobor, helium3])
...
mod_bottom = openmc.ZPlane(118.25)
mod_top = openmc.ZPlane(121.75)

'''
# Mod cyl box

box_left_out = openmc.XPlane(-91)
box_left_in = openmc.XPlane(-89)
box_right_out = openmc.XPlane(-45)
box_right_in = openmc.XPlane(-47)
box_front_out = openmc.YPlane(-67.5)
box_front_in = openmc.YPlane(-65.5)
box_back_out = openmc.YPlane(-47.5)
box_back_in = openmc.YPlane(-49.5)
box_top_out = openmc.ZPlane(130)
box_top_in = openmc.ZPlane(128)
box_bottom_out = openmc.ZPlane(110)
...
# mirrobor_casing = openmc.XCylinder(y0=-57.5, z0=120, r=1.80)
# Tube length = 15.39 cm, detector region length = 2.39 cm, 1.27cm recession
tube_front = openmc.XPlane(-70.247)
tube_back = openmc.XPlane(-54.857)
det_front = openmc.XPlane(-68.977)
det_back = openmc.XPlane(-66.587)
...
# mirrobor_extra_region = +poly_r_left & -concrete_block_right & +mirrobor_extra_front & -poly_r_front & +concrete_block_top & -poly_l_top
...
mirrobor_region = mb_l_region | mb_r_region | mb_back_region # | mirrobor_extra_region
...
# mirrobor_casing_region = +outer_casing & -mirrobor_casing & +tube_front & -tube_back
...
# mod_cyl_box_air_region = +box_left_in & -box_right_in & +box_front_in & -box_back_in & +box_bottom_in & -box_top_in & ~mod_region & ~mirrobor_casing_region & ~steel_casing_region & ~det_region & ~tube_region_1 & ~tube_region_2
# mod_cyl_box_mb_region = +box_left_out & -box_right_out & +box_front_out & -box_back_out & +box_bottom_out & -box_top_out & ~mod_cyl_box_air_region & ~mod_region & ~mirrobor_casing_region & ~steel_casing_region & ~det_region & ~tube_region_1 & ~tube_region_2
...
#mod_cyl_box_mb = openmc.Cell(region=mod_cyl_box_mb_region)
#mod_cyl_box_mb.fill = mirrobor

#mirrobor_casing_cell = openmc.Cell(region=mirrobor_casing_region)
#mirrobor_casing_cell.fill = mirrobor
...
universe = openmc.Universe(cells=[bunker_cell, bunker_wall, floor, corridor_1, corridor_2, outside, door_poly, door_steel,
                                  ...
                                  #mirrobor_casing_cell, mod_cyl_box_air, mod_cyl_box_mb])
...
color_assignment = {bunker_wall: 'blue', bunker_cell: 'red', floor: 'grey', corridor_1: 'red',
                    ...
                    trench_shield_left_wall: 'black', trench_shie ld_left_wall: 'black', trench: 'white', mod_cylinder: 'purple',
                    mirrobor_casing_cell: 'black', steel_casing: 'grey', detector: 'green', tube_1: 'blue', tube_2: 'blue'}
...
time_bins = np.linspace(0, 3E-3, 15000)
energy_bins = np.linspace(0, 0.1, 100)
...
tally.filters = [particle_filter, surface_filter, time_filter]
