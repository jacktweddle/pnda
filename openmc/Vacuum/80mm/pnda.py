...
# Neutron detector - 15.39cm tube, 2.39cm detector recessed 1.27cm
# Detector position chosen to eliminate non-fundamental modes (see book for calcs)

inner_casing_1 = openmc.XCylinder(y0=0, z0=0, r=1.549)
outer_casing_1 = openmc.XCylinder(y0=0, z0=0, r=1.60)
tube_front_1 = openmc.XPlane(10.753)
tube_back_1 = openmc.XPlane(26.143)
det_front_1 = openmc.XPlane(12.023)
det_back_1 = openmc.XPlane(14.413)
...
mod_bottom = openmc.ZPlane(-4)
mod_top = openmc.ZPlane(4)
