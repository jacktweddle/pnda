...
data = pd.read_excel('poly_cylinder_summary_refined.xlsx', sheet_name='Published values', names=('length', 'buckling', 'alpha'), usecols=(0, 1, 2), skiprows=29, nrows=5)
...
x_vals = np.linspace(0, 1.85, 1000)
...
plt.title('α as a function of buckling - 1E7 particles')
